...
public:
	...
	/**
	 *  Get the near distance address
	 *  @returns	The near distance address
	 */
	float& GetNearDistanceRef() {
		return m_nearDistance;
	}
	...
	/**
	*  Get the max speed address
	*  @returns	The max speed address
	*/
	float& GetMaxSpeedRef() {
		return m_maxSpeed;
	}
	...
	/**
	 *  Get the acceleration address
	 *  @returns	The acceleration address
	 */
	float& GetAccelerationRef() {
		return m_nearDistance;
	}
	...
	/**
	 *  Get the damping address
	 *  @returns	The damping address
	 */
	float& GetDampingRef(){
		return m_damping;
	}
	...
	/**
	*  Get the reachable distance address
	*  @returns	The reachable distance address
	*/
	float& GetReachableDistanceRef() {
		return m_reachableDistance;
	}
