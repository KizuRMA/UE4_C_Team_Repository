...
public:
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintSetter = SetNearDistance, Category = "Strix")
	float NearDistance;

	/**
	 * Max speed allowed by interpolation algorithm
	 */
	UPROPERTY(EditAnywhere, BlueprintSetter = SetMaxSpeed , Category = "Strix")
	float MaxSpeed;

	/**
	 * Max acceleration allowed by interpolation algorithm
	 */
	UPROPERTY(EditAnywhere, BlueprintSetter = SetAcceleration, Category = "Strix")
	float Acceleration;

	/**
	 * Damping value applied for smoothing of movement
	 */
	UPROPERTY(EditAnywhere, BlueprintSetter = SetDamping, Category = "Strix")
	float Damping;
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintSetter = SetReachableDistance, Category = "Strix")
	...
	/** Setter of the NearDistance property
	 *	@param	distance	The value to set
	 */
	UFUNCTION(BlueprintCallable)
	void SetNearDistance(float distance);

	/** Setter of the MaxSpeed property
	 *	@param	maxSpeed	The value to set
	 */
	UFUNCTION(BlueprintCallable)
	void SetMaxSpeed(float newMaxSpeed);

	/** Setter of the Acceleration property
	 *	@param	accel   	The value to set
	 */
	UFUNCTION(BlueprintCallable)
	void SetAcceleration(float accel);

	/** Setter of the Damping property
	...
	/** Setter of the ReachableDistance property
	 *	@param	distance	The value to set
	 */
	UFUNCTION(BlueprintCallable)
...
private:
	...
	static const std::string NearDistancePropertyName;
	static const std::string MaxSpeedPropertyName;
	static const std::string AccelerationPropertyName;
	static const std::string DampingPropertyName;
	static const std::string ReachableDistancePropertyName;
