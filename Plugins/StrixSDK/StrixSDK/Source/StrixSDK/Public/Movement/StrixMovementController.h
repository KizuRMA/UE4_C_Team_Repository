...
public:
	...
	virtual void SetNearDistance(float distance) = 0;

	virtual float GetNearDistance() = 0;

	virtual float& GetNearDistanceRef() = 0;

	virtual void SetMaxSpeed(float maxSpeed) = 0;

	virtual float GetMaxSpeed() = 0;

	virtual float& GetMaxSpeedRef() = 0;

	virtual void SetAcceleration(float acceleration) = 0;

	virtual float GetAcceleration() = 0;

	virtual float& GetAccelerationRef() = 0;

	virtual void SetDamping(float damp) = 0;

	virtual float GetDamping() = 0;

	virtual float& GetDampingRef() = 0;

	virtual void SetReachableDistance(float distance) = 0;

	virtual float GetReachableDistance() = 0;

	virtual float& GetReachableDistanceRef() = 0;
