...
public:
	...
	/** Get the sync time period for a given channel.
	 *  @param channelId	The channel ID.
	 *  @returns  The sync time period. Returns -1 if the value could not be found for this channel.
	 */
	UFUNCTION(BlueprintCallable, Category = "StrixBPLibrary", meta = (WorldContext = "WorldContextObject"))
	static int GetSyncTimePeriod(const UObject* WorldContextObject, int channelId);

	/** Set the sync time period for a given channel.
	 *  @param channelId	The channel Id.
	 *  @param	period	The period in milliseconds.
	 */
	UFUNCTION(BlueprintCallable, Category = "StrixBPLibrary", meta = (WorldContext = "WorldContextObject"))
	static void SetSyncTimePeriod(const UObject* WorldContextObject, int channelId, int period);

	/** Get the sync round trip time for a given channel.
	 *  @param channelId	The channel Id.
	 *  @returns  The RTT. Returns -1 if the value could not be found for this channel.
	 */
	UFUNCTION(BlueprintCallable, Category = "StrixBPLibrary", meta = (WorldContext = "WorldContextObject"))
	static int GetSyncRTT(const UObject* WorldContextObject, int channelId);
	...
	/** Get synchronized time with a server.
	*  @param	channedlId The channel to use
	*  @returns Server stored value in ticks of 0.1 microseconds since January 1, 0001.
	*/
	UFUNCTION(BlueprintCallable, Category = "StrixBPLibrary", meta = (WorldContext = "WorldContextObject"))
	static FDateTime GetSynchronizedTime(const UObject* WorldContextObject, int32 channelId);
	...
	/** Converts a map of int-bool key-values to StrixRelayArg structure (used for RPC)
	*  @param	val	The value to convert
	*  @returns	The StrixRelayArg wrapping the provided value
	*/
	UFUNCTION(BlueprintPure, meta = (DisplayName = "ToStrixRelayArg (map<int, bool>)", CompactNodeTitle = "->", Keywords = "cast convert"), Category = "StrixBPLibrary|Conversions")
	static FStrixRelayArg Conv_IntKeyBoolMapToStrixRelayArg(TMap<int32, bool> val);
	...
	/** Converts a map of string-bool key-values to StrixRelayArg structure (used for RPC)
	 *  @param	val	The value to convert
	 *  @returns	The StrixRelayArg wrapping the provided value
	 */
	UFUNCTION(BlueprintPure, meta = (DisplayName = "ToStrixRelayArg (map<string, bool>)", CompactNodeTitle = "->", Keywords = "cast convert"), Category = "StrixBPLibrary|Conversions")
	static FStrixRelayArg Conv_StringKeyBoolMapToStrixRelayArg(TMap<FString, bool> val);
