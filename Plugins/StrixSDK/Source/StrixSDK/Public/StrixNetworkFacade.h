...
DECLARE_DYNAMIC_DELEGATE(FStrixMasterServerDisconnectedDelegate);
...
typedef std::function<void(int)> RoomServerDisconnectHandler;
...
public:
	...
	*/
	FDateTime GetSynchronizedTime(int channelId);
	...
	TArray<FStrixRoomMember> GetCurrentRoomMembers(int channelId);
        ...
        /** Get the room member with the given UID. Used for retrieving member information without a regular ID.
         *  @param  channelId The channel to use
         *  @param  uid  The ID of the member
         *  @returns  A StrixRoomMember structure containing information about the given member, or an empty member if not found.
         */
	FStrixRoomMember GetRoomMemberByUID(int channelId, strix::client::core::UIDPtr uid);
	 ...
	 */
	long long GetSyncTimePeriod(int channelId);

	/** Set the sync time period for a given channel.
	 *  @param channelId	The channel Id.
	 *  @param	period	The period in milliseconds.
	 */
	void SetSyncTimePeriod(int channelId, long long period);
	 ...
	 */
	long long GetSyncRTT(int channelId);
	...
	strix::client::core::util::DelegateList<int>::Handle AddRoomServerDisconnectHandler(RoomServerDisconnectHandler handler);
	void RemoveRoomServerDisconnectHandler(strix::client::core::util::DelegateList<>::Handle handle);
...
private:
	...
	strix::client::core::util::DelegateList<int> m_roomServerDisconnectDelegate;
