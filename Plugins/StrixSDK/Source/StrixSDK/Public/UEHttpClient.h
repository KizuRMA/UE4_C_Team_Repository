...
class UEHttpClient : public strix::client::core::http::HttpClient
{
	...
	typedef TSharedRef<IHttpRequest, ESPMode::ThreadSafe> HttpRequestRef;
#else
	typedef TSharedRef<IHttpRequest> HttpRequestRef;
#endif
...
private:
	 ...
	 */
	HttpRequestRef PrepareRequestBase(strix::client::core::http::HttpRequest& request);
