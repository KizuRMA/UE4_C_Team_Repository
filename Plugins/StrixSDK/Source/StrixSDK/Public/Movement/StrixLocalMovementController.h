...
public:
	...
	void SetNearDistance(float distance) override;

	float GetNearDistance() override;

	float& GetNearDistanceRef() override;

	void SetMaxSpeed(float maxSpeed) override;

	float GetMaxSpeed() override;

	float& GetMaxSpeedRef() override;

	void SetAcceleration(float acceleration) override;

	float GetAcceleration() override;

	float& GetAccelerationRef() override;

	void SetDamping(float damp) override;

	float GetDamping() override;

	float& GetDampingRef() override;

	void SetReachableDistance(float distance) override;

	float GetReachableDistance() override;

	float& GetReachableDistanceRef() override;
