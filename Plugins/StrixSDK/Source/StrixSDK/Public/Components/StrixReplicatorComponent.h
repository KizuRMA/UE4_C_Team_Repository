...
public:
	...
	void OnRoomContextOpen(int roomContextChannelId, strix::client::ingame::network::RoomContextPtr roomContext);
        ...
        /** Returns the room member that owns the replica this replicator component manages.
         *  @returns  The room member or an empty room member if this replicator does not have an owner.
         */
	UFUNCTION(BlueprintCallable)
	FStrixRoomMember GetRoomMember();
