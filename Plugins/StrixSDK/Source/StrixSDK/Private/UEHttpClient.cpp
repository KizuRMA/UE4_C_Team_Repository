...
{
	HttpRequestRef httpRequest = PrepareRequestBase(request);
...
UEHttpClient::HttpRequestRef UEHttpClient::PrepareRequestBase(strix::client::core::http::HttpRequest& request)
{
	HttpRequestRef httpRequest = m_httpModule->CreateRequest();
