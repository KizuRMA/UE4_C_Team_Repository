...
void StrixLocalMovementController::SetNearDistance(float distance)
{
	m_movementInterpolator.SetNearDistance(distance);
}

float StrixLocalMovementController::GetNearDistance()
{
	return m_movementInterpolator.GetNearDistance();
}

float& StrixLocalMovementController::GetNearDistanceRef()
{
	return m_movementInterpolator.GetNearDistanceRef();
}

void StrixLocalMovementController::SetMaxSpeed(float maxSpeed)
{
	m_movementInterpolator.SetMaxSpeed(maxSpeed);
}

float StrixLocalMovementController::GetMaxSpeed()
{
	return m_movementInterpolator.GetMaxSpeed();
}

float& StrixLocalMovementController::GetMaxSpeedRef()
{
	return m_movementInterpolator.GetMaxSpeedRef();
}

void StrixLocalMovementController::SetAcceleration(float acceleration)
{
	m_movementInterpolator.SetAcceleration(acceleration);
}

float StrixLocalMovementController::GetAcceleration()
{
	return m_movementInterpolator.GetAcceleration();
}

float& StrixLocalMovementController::GetAccelerationRef()
{
	return m_movementInterpolator.GetAccelerationRef();
}

void StrixLocalMovementController::SetDamping(float damp)
{
	m_movementInterpolator.SetDamping(damp);
}

float StrixLocalMovementController::GetDamping()
{
	return m_movementInterpolator.GetDamping();
}

float& StrixLocalMovementController::GetDampingRef()
{
	return m_movementInterpolator.GetDampingRef();
}

void StrixLocalMovementController::SetReachableDistance(float distance)
{
	m_movementInterpolator.SetReachableDistance(distance);
}

float StrixLocalMovementController::GetReachableDistance()
{
	return m_movementInterpolator.GetReachableDistance();
}

float& StrixLocalMovementController::GetReachableDistanceRef()
{
