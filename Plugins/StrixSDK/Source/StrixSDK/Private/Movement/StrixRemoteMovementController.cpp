...
void StrixRemoteMovementController::SetNearDistance(float distance)
{
	m_movementInterpolator.SetNearDistance(distance);
}

float StrixRemoteMovementController::GetNearDistance()
{
	return m_movementInterpolator.GetNearDistance();
}

float& StrixRemoteMovementController::GetNearDistanceRef()
{
	return m_movementInterpolator.GetNearDistanceRef();
}

void StrixRemoteMovementController::SetMaxSpeed(float maxSpeed)
{
	m_movementInterpolator.SetMaxSpeed(maxSpeed);
}

float StrixRemoteMovementController::GetMaxSpeed()
{
	return m_movementInterpolator.GetMaxSpeed();
}

float& StrixRemoteMovementController::GetMaxSpeedRef()
{
	return m_movementInterpolator.GetMaxSpeedRef();
}

void StrixRemoteMovementController::SetAcceleration(float acceleration)
{
	m_movementInterpolator.SetAcceleration(acceleration);
}

float StrixRemoteMovementController::GetAcceleration()
{
	return m_movementInterpolator.GetAcceleration();
}

float& StrixRemoteMovementController::GetAccelerationRef()
{
	return m_movementInterpolator.GetAccelerationRef();
}

void StrixRemoteMovementController::SetDamping(float damp)
{
	m_movementInterpolator.SetDamping(damp);
}

float StrixRemoteMovementController::GetDamping()
{
	return m_movementInterpolator.GetDamping();
}

float& StrixRemoteMovementController::GetDampingRef()
{
	return m_movementInterpolator.GetDampingRef();
}

void StrixRemoteMovementController::SetReachableDistance(float distance)
{
	m_movementInterpolator.SetReachableDistance(distance);
}

float StrixRemoteMovementController::GetReachableDistance()
{
	return m_movementInterpolator.GetReachableDistance();
}

float& StrixRemoteMovementController::GetReachableDistanceRef()
{
	return m_movementInterpolator.GetReachableDistanceRef();
}
