...
public:
	...
	const MetaClass& GetValueType() const override {
		return Get();
	}
...
template <typename T>
class MetaClassT<std::shared_ptr<T>, false> : public MetaClassBaseT<std::shared_ptr<T>>
{
public:
	typedef MetaClassT<T, HasInitMetaClassMethod<T>::value> ValueType;
	
	static const MetaClassT& Get() {
		static const MetaClassT<std::shared_ptr<T>, false> instance;
		return instance;
	}

	void* Create() const override {
		return ValueType::Get().Create();
	}
...
private:
	MetaClassT() {
		MetaClass::SetClassId(TypeNameFactory<std::shared_ptr<T>>::GetTypeName(false));
		MetaClass::Register(*this, MetaClass::GetClassId());
	}
};

template <typename T>
class MetaClassT<std::weak_ptr<T>, false> : public MetaClassBaseT<std::weak_ptr<T>>
{
public:
	typedef MetaClassT<T, HasInitMetaClassMethod<T>::value> ValueType;

	static const MetaClassT& Get() {
		static const MetaClassT<std::weak_ptr<T>, false> instance;
		return instance;
	}
...
private:
	MetaClassT() {
		MetaClass::SetClassId(TypeNameFactory<std::weak_ptr<T>>::GetTypeName(false));
		MetaClass::Register(*this, MetaClass::GetClassId());
	}
};

template <typename T>
class MetaClassT<std::unique_ptr<T>, false> : public MetaClassBaseT<std::unique_ptr<T>>
{
public:
	typedef MetaClassT<T, HasInitMetaClassMethod<T>::value> ValueType;

	static const MetaClassT& Get() {
		static const MetaClassT<std::unique_ptr<T>, false> instance;
		return instance;
	}
...
private:
	MetaClassT() {
		MetaClass::SetClassId(TypeNameFactory<std::unique_ptr<T>>::GetTypeName(false));
		MetaClass::Register(*this, MetaClass::GetClassId());
	}
};
...
template <typename T>
class TypeNameFactory<std::weak_ptr<T>>
{
public:
	static std::string GetTypeName(bool)
	{
		return "std::weak_ptr<" + TypeNameFactory<T>::GetTypeName(true) + ">";
	}
};

template <typename T>
class TypeNameFactory<std::unique_ptr<T>>
{
public:
	static std::string GetTypeName(bool)
	{
		return "std::unique_ptr<" + TypeNameFactory<T>::GetTypeName(true) + ">";
	}
};
